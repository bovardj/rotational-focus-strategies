      ...
      >
        <Collapse shadow title="General" initialVisible className="bg-gray-50">
          ...
          <p className="mb-4">
            ...
            focus strategy (from your selected strategies) to use each day.
            Then, at the end of the day, you will be asked to complete a survey
          ...
          <ul className="list-disc pl-6">
            <li>
              ...
              your focus strategies. Additionally, it is possible that you will
              be assigned the same Focus Strategy two days in a row.
            </li>
            <li>
        ...
        <Collapse
          shadow
          title={`Baseline Days (first ${baselineSurveysExpected} days)`}
          className="bg-gray-50"
        >
          <ul className="list-disc pl-6">
        ...
        <Collapse
          shadow
          title={`Assigned Focus Strategy Days (for ${dailySurveysExpected} days after baseline)`}
          className="bg-gray-50"
        >
          <ul className="list-disc pl-6">
            <li className="mb-2">
        ...
        <Collapse shadow title="Last Day" className="bg-gray-50">
          <ul className="list-disc pl-6">
            ...
            <li>
              <p className="mb-2">
                I will delete all of your data from the apps database within one
                week of your Exit Survey submission. Associations to your email
                address or other potentially identifying information will be
                deleted and data transfered to an anonymized spreadsheet for
                analysis and reporting purposes.
              </p>
              <p>
                While you can continue to use the app and get assigned
                strategies after your last survey, this will no longer be the
                case once I delete your data from the database.
              </p>
            </li>
          </ul>
        </Collapse>
